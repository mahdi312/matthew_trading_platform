 ...
 * (both current values for signal scoring and full series for chart rendering).
 * Ported from desktop {@code service.analysis.IndicatorResult}.
 */
@Data
...
public class IndicatorResult {
    ...
    @Builder.Default private int     emaCrossSignal       = 0;
    ...
    public static IndicatorResult empty() { return IndicatorResult.builder().build(); }
}
