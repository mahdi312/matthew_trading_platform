...
public class DrawingPropertiesDialog {
    ...
    public static void show(ChartDrawing drawing, Window owner, Consumer<ChartDrawing> onApply) {
        ...
        ChartDrawingProperties props = null;
        ...
        if (hasFill) {
            ...
            ChartDrawingProperties finalProps1 = props;
            dialog.showAndWait().ifPresent(bt -> {
                if (bt == ButtonType.OK) {
                    finalProps1.setColor(colorHolder[0]);
                    finalProps1.setLineWidth(weightSlider.getValue());
                    finalProps1.setLineStyle(styleCombo.getValue());
                    finalProps1.setFillOpacity(opacitySlider.getValue());
